...
public class ApplicationForLeaveDetailsController {
    ...
    private void prepareDetailView(Application application, int year, String action, boolean shortcut, Model model) {
        ...
        if (account.isPresent()) {
            ...
            Optional<Account> nextYear = accountService.getHolidaysAccount(year+1, application.getPerson());
            model.addAttribute("vacationDaysLeft", vacationDaysService.getVacationDaysLeft(acc, nextYear));
